...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700' rel='stylesheet' type='text/css'>
     ...
     @yield('heders')
<link href="{{asset('NewTemplate/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('NewTemplate/css/nifty.min.css')}}" rel="stylesheet">
    <link href="{{asset('NewTemplate/css/demo/nifty-demo-icons.min.css')}}" rel="stylesheet">
    <link href="{{asset('NewTemplate/plugins/pace/pace.min.css')}}" rel="stylesheet">
    <script src="{{asset('NewTemplate/plugins/pace/pace.min.js')}}"></script>
    <link href="{{asset('NewTemplate/css/demo/nifty-demo.min.css')}}" rel="stylesheet">
    <link href="{{asset('NewTemplate/plugins/fooTable/css/footable.core.css')}}" rel="stylesheet">
...
<body>
            ...
            <div id="navbar-container" class="boxed">
                <div class="navbar-header">
                    <a href="index.html" class="navbar-brand">
                        <img src="{{asset('NewTemplate/img/logo.png')}}" alt="Nifty Logo" class="brand-icon">
                        <div class="brand-title">
                            <span class="brand-text">Cross-Web</span>
                        </div>
                    </a>
                </div>
                                    ...
                                    <div class="nano-content">
                                        <ul class="head-list">
                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="img-circle img-sm" alt="Profile Picture" src="NewTemplate/img/profile-photos/9.png">
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="img-circle img-sm" alt="Profile Picture" src="NewTemplate/img/profile-photos/3.png">
                                                    </div>
                                                    <div class="media-body">
                        ...
                        <li id="dropdown-user" class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                <span class="ic-user pull-right">
                                    ...
                                    <!--<img class="img-circle img-user media-object" src="NewTemplate/img/profile-photos/1.png" alt="Profile Picture">-->
                                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<div class="pad-all text-center">
						<h3>Bienvenido a la solucion</h3>
						<p>La solucion de los problemas tecnicos de tu emprasa mas cerca de lo que piensas</p>
					</div>
               </div>
                <div id="page-content">
					    <div class="row">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="demo-asd-tab-1">
                                    ...
                                    <div class="list-group bg-trans">
							            ...
							            <a href="#" class="list-group-item">
							                <div class="media-left pos-rel">
							                    <img class="img-circle img-xs" src="NewTemplate/img/profile-photos/7.png" alt="Profile Picture">
							                </div>
							                <div class="media-body">
							            ...
							            <a href="#" class="list-group-item">
							                <div class="media-left pos-rel">
							                    <img class="img-circle img-xs" src="NewTemplate/img/profile-photos/1.png" alt="Profile Picture">
							            ...
							            <a href="#" class="list-group-item">
							                <div class="media-left pos-rel">
							                    <img class="img-circle img-xs" src="NewTemplate/img/profile-photos/4.png" alt="Profile Picture">
							                </div>
							                <div class="media-body">
							            ...
							            <a href="#" class="list-group-item">
							                <div class="media-left pos-rel">
							                    <img class="img-circle img-xs" src="NewTemplate/img/profile-photos/8.png" alt="Profile Picture">
							            ...
							            <a href="#" class="list-group-item">
							                <div class="media-left pos-rel">
							                    <img class="img-circle img-xs" src="NewTemplate/img/profile-photos/9.png" alt="Profile Picture">
                            ...
                            <div class="nano-content">
                                ...
                                <div id="mainnav-profile" class="mainnav-profile">
                                    <div class="profile-wrap text-center">
                                        <div class="pad-btm">
                                            <img class="img-circle img-md" src="NewTemplate/img/profile-photos/1.png" alt="Profile Picture">
                                        </div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li>
						                <a href="#">
						                    ...
						                    <span class="menu-title">Gestion del Tecnico</span>
											<i class="arrow"></i>
						                </a>
						
						                <!--Submenu-->
						                <ul class="collapse">
                                        <li><a href="{{url('/Tecnico/index')}}">Gestionar Tecnico</a></li>
                                            <li><a href="{{url('/servicio/index')}}">Gestionar Servicio</a></li>
											<li><a href="{{url('/Horario/index')}}">Gestionar Horario</a></li>
                                        <li><a href="{{url('/Estado/index')}}">Gestionar Estado</a></li>
						                </ul>
						            </li>
						
						            <!--Menu list item-->
						            <li>
                                    <a href="{{url('solicitud/index')}}">
    ...
    <script src="{{asset('NewTemplate/js/bootstrap.min.js')}}"></script>


    <!--NiftyJS [ RECOMMENDED ]-->
    <script src="{{asset('NewTemplate/js/nifty.min.js')}}"></script>
    ...
    <script src="{{asset('NewTemplate/js/demo/nifty-demo.min.js')}}"></script>
    <script src="{{asset('NewTemplate/js/demo/tables-footable.js')}}"></script>
    <script src="{{asset('NewTemplate/plugins/fooTable/dist/footable.all.min.js')}}"></script>
    
    <!--Flot Chart [ OPTIONAL ]-->
    <script src="{{asset('NewTemplate/plugins/flot-charts/jquery.flot.min.js')}}"></script>
	<script src="{{asset('NewTemplate/plugins/flot-charts/jquery.flot.resize.min.js')}}"></script>
	<script src="{{asset('NewTemplate/plugins/flot-charts/jquery.flot.tooltip.min.js')}}"></script>


    <!--Sparkline [ OPTIONAL ]-->
    <script src="{{asset('NewTemplate/plugins/sparkline/jquery.sparkline.min.js')}}"></script>


    <!--Specify page [ SAMPLE ]-->
    <script src="{{asset('NewTemplate/js/demo/dashboard.js')}}"></script>
    ...
    <script src="https://www.gstatic.com/firebasejs/5.9.1/firebase-messaging.js"></script>
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyAhDWSTYr1npJ-BV5ZWmFxPBn1aoMU9ABA",
            authDomain: "notificacion-6dc06.firebaseapp.com",
            databaseURL: "https://notificacion-6dc06.firebaseio.com",
            projectId: "notificacion-6dc06",
            storageBucket: "notificacion-6dc06.appspot.com",
            messagingSenderId: "1062260322689",
            appId: "1:1062260322689:web:8e4f3502c01cd470"
        };
        // Initialize Firebase
...
<!-- Mirrored from www.themeon.net/nifty/v2.9.1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 May 2019 04:20:11 GMT -->
</html>
